"""
Test OTA Update Function on HB-RF-ETH-ng

This script allows you to test the OTA update functionality directly from the command line.
It handles authentication, triggers the update process, and monitors progress.

Usage:
    python3 test_ota_function.py <IP_ADDRESS> <ADMIN_PASSWORD> [--url <FIRMWARE_URL>]

Examples:
    # Standard update to v2.1.7 (default)
    python3 test_ota_function.py 192.168.178.50 myAdminPassword

    # Update with specific firmware URL
    python3 test_ota_function.py 192.168.178.50 myAdminPassword --url "https://example.com/firmware.bin"
"""
