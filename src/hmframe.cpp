...
// ============================================================================
// Optimized CRC16 with Look-Up Table (LUT)
// Performance: ~5-8x faster than bit-by-bit calculation
// Memory cost: 512 bytes (256 * uint16_t)
// Polynomial: 0x8005, Initial: 0xd77f
// ============================================================================

// Pre-computed CRC16 lookup table for polynomial 0x8005
...
uint16_t HMFrame::crc(unsigned char *buffer, uint16_t len)
{
    ...
    // LUT-based CRC calculation - much faster than bit-by-bit
    while (len--)
    {
        uint8_t index = (crc >> 8) ^ (*buffer++);
