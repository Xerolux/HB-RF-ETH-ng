export default {
  ...
  settings: {
    ...
    checkUpdates: 'Sjekk automatisk for oppdateringer',
  ...
  firmware: {
    ...
    latestVersion: 'Siste tilgjengelige versjon',
    versionInfo: 'Modernisert fork v2.1 av Xerolux (2025) - Basert på det opprinnelige arbeidet til Alexander Reinert.',
    upToDate: 'Fastvaren din er oppdatert.',
    updateAvailable: 'Oppdatering tilgjengelig: Versjon {currentVersion} → {latestVersion}',
    versionCheckFailed: 'Versjonssjekk mislyktes. Kontroller internettforbindelsen og prøv igjen.',
    onlineUpdate: 'Online oppdatering',
    checkUpdate: 'Sjekk for oppdateringer nå',
    noUpdateAvailable: 'Ingen oppdatering tilgjengelig. Du kjører allerede den nyeste versjonen.',
    onlineUpdateConfirm: 'Vil du virkelig laste ned og installere oppdateringen? Systemet vil starte på nytt automatisk.',
    onlineUpdateStarted: 'Oppdatering startet. Enheten vil starte på nytt automatisk når den er ferdig.',
    showReleaseNotes: 'Vis versjonsmerknader',
    releaseNotesTitle: 'Versjonsmerknader for v{version}',
    releaseNotesError: 'Kunne ikke laste versjonsmerknader.',
    downloadFirmware: 'Last ned fastvare',
