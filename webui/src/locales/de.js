export default {
  ...
  firmware: {
    ...
    upToDate: 'Ihre Firmware ist auf dem neuesten Stand.',
    updateAvailable: 'Update verfügbar: Version {currentVersion} → {latestVersion}',
    versionCheckFailed: 'Versionscheck fehlgeschlagen. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut.',
    onlineUpdate: 'Online Update durchführen',
    checkUpdate: 'Jetzt nach Updates suchen',
    noUpdateAvailable: 'Kein Update verfügbar. Sie nutzen bereits die neueste Version.',
    ...
    releaseNotesError: 'Release Notes konnten nicht geladen werden.',
    downloadFirmware: 'Firmware herunterladen',
