export default {
  ...
  settings: {
    ...
    restoreSuccess:
      "Einstellungen erfolgreich wiederhergestellt. System startet neu...",
  ...
  firmware: {
    ...
    warning:
      "Warnung: Unterbrechen Sie nicht die Stromversorgung während des Updates!",
  ...
  monitoring: {
    title: "Monitoring",
    description:
      "Konfigurieren Sie SNMP und CheckMK Monitoring für das HB-RF-ETH Gateway.",
    save: "Speichern",
    saving: "Speichern...",
