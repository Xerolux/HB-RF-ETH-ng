export default {
  ...
  diagnostics: {
    ...
    txFailed: 'Sendefehler zur CCU',
    uartKicker: 'Funkmodul',
    uartHeading: 'Verbindung zum Funkmodul (UART)',
    uartHelp: 'Die Werte oben messen die Strecke zur CCU. Diese hier messen die Strecke zum Funkmodul — der einzige Pfad, auf dem empfangene Funkframes verworfen werden können, ohne dass ein CCU-seitiger Zähler reagiert.',
    uartUnsupported: 'Diese Firmware liefert noch keine Funkmodul-Zähler. Bitte auf eine neuere Version aktualisieren.',
    uartOverflows: 'Pufferüberläufe',
    uartLostBytes: 'Verworfene Bytes',
    uartLineErrors: 'Leitungsfehler',
    uartTxErrors: 'Sendefehler',
    uartBacklogMax: 'Maximaler Rückstau',
    uartRxFrames: 'Frames vom Modul',
    uartTxFrames: 'Frames zum Modul',
    uartOversize: 'Übergroße Ereignisse',
    uartNote: 'Alles außer null bedeutet: Funkverkehr ist in dieser Firmware verloren gegangen. Die CCU wiederholt die Sendung dann, was den Duty Cycle erhöht und ein Gerät irgendwann als gestört erscheinen lässt. Bitte in diesem Fall einen Screenshot im Issue #447 posten.',
  ...
  webuiUpdate: {
    ...
    onlineHelp: 'Das Gerät fragt eine kleine Versionsdatei ab und vergleicht sie mit der installierten WebUI. Es lädt und installiert dabei nichts.',
    upToDate: 'WebUI ist aktuell — {version} ist die neueste veröffentlichte Version.',
    installHint: 'Zum Installieren das webui_*.bin aus dem Release herunterladen und unten hochladen.',
    ...
    statusLoadError: 'Gerätestatus konnte nicht geladen werden. Bitte Seite neu laden.',
    ...
    fileStatusMissing: 'Gerätestatus nicht verfügbar. Bitte Seite neu laden und erneut versuchen.',
  ...
  firmware: {
    ...
    onlineKicker: 'Update-Suche',
    onlineHeading: 'Online nach Updates suchen',
    onlineHelp: 'Das Gerät fragt eine kleine Versionsdatei ab und vergleicht sie mit dem, was installiert ist. Es lädt und installiert dabei nichts.',
    onlineManualNote: 'Die Suche läuft nur auf Knopfdruck — das Gerät sucht nicht von selbst im Hintergrund.',
    checkNow: 'Jetzt nach Updates suchen',
    checking: 'Suche läuft …',
    channelLabel: 'Kanal',
    channelStable: 'Stabil',
    channelBeta: 'Beta',
    neverChecked: 'Noch keine Suche durchgeführt.',
    lastCheck: 'Letzte Suche',
    upToDate: 'Alles aktuell — Firmware {fw} und WebUI {ui} sind die neuesten Versionen.',
    firmwareAvailable: 'Neue Firmware verfügbar: {version}',
    webuiAvailable: 'Neue WebUI verfügbar: {version}',
    installHint: 'Zum Installieren die Datei aus dem Release herunterladen und unten hochladen.',
    releaseNotes: 'Release-Hinweise ansehen',
    checkSkipped: 'Suche übersprungen: {reason}',
    checkFailed: 'Suche fehlgeschlagen: {reason}',
    checkCooldown: 'Bitte kurz warten — es wurde gerade erst gesucht.',
    checkCooldownRetry: 'Gerade erst gesucht — versuche es in {seconds} Sekunden erneut.',
    skipLowMemory: 'zu wenig freier Speicher (frei: {free} KB, größter Block: {largest} KB)',
    skipInstallRunning: 'eine Update-Installation läuft gerade',
    skipNetworkBusy: 'das Netzwerk-Subsystem ist beschäftigt',
    skipManifestBuffer: 'zu wenig Speicher für den Versions-Puffer',
  ...
  monitoring: {
    ...
    resourceWarningText: 'Es sind {count} Monitoring-Dienste aktiv. Der ESP32 kann das normalerweise bedienen, aber gleichzeitige TLS-Verbindungen und ein manueller Firmware-Upload teilen sich Heap und CPU; bei Problemen bitte einzelne Dienste deaktivieren oder Tests zeitlich versetzen.',
    save: 'Speichern',
    saving: 'Speichern...',
    ...
    notify: {
      ...
      eventsSection: 'Ereignisauswahl',
      eventsHelp: 'Nur die hier ausgewählten Ereignisse lösen eine Benachrichtigung aus. Die Testbenachrichtigung wird unabhängig davon immer gesendet.',
      eventsSelectAll: 'Alle auswählen',
      eventsSelectNone: 'Keine auswählen',
      eventsNoneWarning: 'Es ist kein Ereignis ausgewählt — außer der Testbenachrichtigung wird nichts gesendet.',
      eventEthLinkDown: 'Netzwerkverbindung verloren',
      eventEthLinkUp: 'Netzwerkverbindung wiederhergestellt',
      eventRfModuleLost: 'Funkmodul antwortet nicht mehr',
      eventRfModuleDetected: 'Funkmodul erkannt',
      eventMqttDisconnected: 'MQTT-Verbindung verloren',
      eventMqttReconnected: 'MQTT-Verbindung wiederhergestellt',
      eventFactoryReset: 'Werksreset ausgelöst',
      eventRestart: 'Neustart ausgelöst',
      eventCcuConnected: 'CCU verbunden',
      eventCcuDisconnected: 'CCU getrennt',
      eventLowHeap: 'Wenig freier Speicher',
