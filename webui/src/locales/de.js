export default {
  ...
  settings: {
    ...
    dtlsDescription: 'Sichere Transportverschlüsselung für die Kommunikation zwischen Platine und CCU über Port 3008.',
    dtlsMode: 'Verschlüsselungsmodus',
    dtlsModeDisabled: 'Deaktiviert (Standard)',
    dtlsModePsk: 'Pre-Shared Key (PSK)',
    dtlsModeCertificate: 'X.509 Zertifikat',
    dtlsCipherSuite: 'Cipher Suite',
    dtlsCipherAes128: 'AES-128-GCM-SHA256',
    dtlsCipherAes256: 'AES-256-GCM-SHA384 (Empfohlen)',
    dtlsCipherChacha: 'ChaCha20-Poly1305-SHA256',
    dtlsRequireClientCert: 'Client-Zertifikat erforderlich',
    dtlsSessionResumption: 'Session Resumption aktivieren',
    dtlsPskManagement: 'PSK Verwaltung',
    dtlsPskIdentity: 'PSK Identity',
    dtlsPskKey: 'PSK Schlüssel (Hex)',
    dtlsPskGenerate: 'Neuen PSK generieren',
    dtlsPskGenerating: 'PSK wird generiert...',
    dtlsPskGenerated: 'Neuer PSK wurde generiert',
    dtlsPskCopyWarning: 'WICHTIG: Kopieren Sie diesen Schlüssel jetzt! Er wird nur einmal angezeigt.',
    dtlsPskKeyLength: 'Schlüssellänge',
    dtlsPsk128bit: '128 Bit',
    dtlsPsk256bit: '256 Bit (Empfohlen)',
    dtlsPsk384bit: '384 Bit',
    dtlsPsk512bit: '512 Bit',
    dtlsPskStatus: 'PSK Status',
    dtlsPskConfigured: 'Konfiguriert',
    dtlsPskNotConfigured: 'Nicht konfiguriert',
    dtlsWarningDisabled: 'Die Kommunikation ist UNVERSCHLÜSSELT. Jeder im Netzwerk kann mitlesen.',
    dtlsWarningPsk: 'Stellen Sie sicher, dass der PSK sicher auf der CCU gespeichert ist.',
    dtlsInfo: 'DTLS 1.2 verschlüsselt die Raw-UART UDP Kommunikation Ende-zu-Ende. Die CCU muss ebenfalls DTLS unterstützen.',
    dtlsDocumentation: 'Dokumentation für CCU-Entwickler',
    dtlsViewDocs: 'Implementierungsanleitung anzeigen',
