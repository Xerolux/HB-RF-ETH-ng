export default {
  ...
  settings: {
    ...
    flashPauseHint: 'Dopo un riavvio causato da un aggiornamento firmware o da una modifica delle impostazioni, scollega il collegamento Ethernet per circa 35 s prima del riavvio, in modo che il watchdog della CCU rilevi la disconnessione e riavvii in modo pulito.',
  ...
  diagnostics: {
    ...
    txFailed: 'Errori di invio alla CCU',
    uartKicker: 'Modulo radio',
    uartHeading: 'Collegamento al modulo radio (UART)',
    uartHelp: 'I valori sopra misurano il percorso verso la CCU. Questi misurano il percorso verso il modulo radio — l’unico in cui i frame radio ricevuti possono essere scartati senza che alcun contatore lato CCU si muova.',
    uartUnsupported: 'Questo firmware non fornisce ancora i contatori del modulo radio. Aggiornare a una versione più recente.',
    uartOverflows: 'Overflow del buffer',
    uartLostBytes: 'Byte scartati',
    uartLineErrors: 'Errori di linea',
    uartTxErrors: 'Errori di invio',
    uartBacklogMax: 'Arretrato massimo',
...
webuiUpdate: {
  ...
  onlineHelp: 'Il dispositivo scarica un piccolo file di versioni e lo confronta con la WebUI installata. Non scarica né installa nulla.',
  upToDate: 'La WebUI è aggiornata: {version} è la versione pubblicata più recente.',
  installHint: 'Per installare, scarica il webui_*.bin dalla release e caricalo qui sotto.',
  ...
  statusLoadError: 'Impossibile caricare lo stato del dispositivo. Ricarica la pagina.',
  ...
  fileStatusMissing: 'Lo stato del dispositivo non è disponibile. Ricarica la pagina e riprova.',
  ...
  firmware: {
    ...
    onlineKicker: 'Ricerca aggiornamenti',
    onlineHeading: 'Cerca aggiornamenti online',
    onlineHelp: 'Il dispositivo scarica un piccolo file di versioni e lo confronta con quanto installato. Non scarica né installa nulla.',
    onlineManualNote: 'La ricerca viene eseguita solo premendo il pulsante: il dispositivo non cerca mai da solo in background.',
    checkNow: 'Cerca aggiornamenti ora',
    checking: 'Ricerca in corso …',
    channelLabel: 'Canale',
    channelStable: 'Stabile',
    channelBeta: 'Beta',
    neverChecked: 'Nessuna ricerca ancora eseguita.',
    lastCheck: 'Ultima ricerca',
    upToDate: 'Tutto aggiornato: il firmware {fw} e la WebUI {ui} sono le versioni più recenti.',
    firmwareAvailable: 'Nuovo firmware disponibile: {version}',
    webuiAvailable: 'Nuova WebUI disponibile: {version}',
    installHint: 'Per installare, scarica il file dalla release e caricalo qui sotto.',
    releaseNotes: 'Visualizza le note di rilascio',
    checkSkipped: 'Ricerca saltata: {reason}',
    checkFailed: 'Ricerca non riuscita: {reason}',
    checkCooldown: 'Attendi un momento: una ricerca è appena stata eseguita.',
    checkCooldownRetry: 'Una ricerca è appena stata eseguita — riprova tra {seconds} secondi.',
    skipLowMemory: 'poca memoria libera (libera: {free} KB, blocco più grande: {largest} KB)',
    skipInstallRunning: 'un’installazione di aggiornamento è in corso',
    skipNetworkBusy: 'il sottosistema di rete è occupato',
    skipManifestBuffer: 'memoria insufficiente per il buffer delle versioni',
  ...
  monitoring: {
    ...
    notify: {
      ...
      eventsSection: 'Selezione degli eventi',
      eventsHelp: 'Solo gli eventi selezionati qui attivano una notifica. La notifica di test viene sempre inviata.',
      eventsSelectAll: 'Seleziona tutto',
      eventsSelectNone: 'Deseleziona tutto',
      eventsNoneWarning: 'Nessun evento selezionato — verrà inviata solo la notifica di test.',
      eventEthLinkDown: 'Collegamento di rete perso',
      eventEthLinkUp: 'Collegamento di rete ripristinato',
      eventRfModuleLost: 'Il modulo radio non risponde più',
      eventRfModuleDetected: 'Modulo radio rilevato',
      eventMqttDisconnected: 'Connessione MQTT persa',
      eventMqttReconnected: 'Connessione MQTT ripristinata',
      eventFactoryReset: 'Ripristino di fabbrica avviato',
      eventRestart: 'Riavvio avviato',
      eventCcuConnected: 'CCU connessa',
      eventCcuDisconnected: 'CCU disconnessa',
      eventLowHeap: 'Memoria libera insufficiente',
