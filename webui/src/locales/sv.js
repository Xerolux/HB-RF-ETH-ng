export default {
  ...
  settings: {
    ...
    checkUpdates: 'Kontrollera automatiskt efter uppdateringar',
  ...
  firmware: {
    ...
    latestVersion: 'Senaste tillgängliga version',
    versionInfo: 'Moderniserad fork v2.1 av Xerolux (2025) - Baserad på det ursprungliga arbetet av Alexander Reinert.',
    upToDate: 'Din firmware är uppdaterad.',
    updateAvailable: 'Uppdatering tillgänglig: Version {currentVersion} → {latestVersion}',
    versionCheckFailed: 'Versionskontroll misslyckades. Kontrollera din internetanslutning och försök igen.',
    onlineUpdate: 'Online-uppdatering',
    checkUpdate: 'Kontrollera uppdateringar nu',
    noUpdateAvailable: 'Ingen uppdatering tillgänglig. Du kör redan den senaste versionen.',
    ...
    releaseNotesTitle: 'Versionsanteckningar för v{version}',
    releaseNotesError: 'Kunde inte ladda versionsanteckningar.',
    downloadFirmware: 'Ladda ner firmware',
