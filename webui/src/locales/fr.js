export default {
  ...
  settings: {
    ...
    backupInfo:
      "Téléchargez une sauvegarde de vos paramètres pour les restaurer plus tard.",
    restoreInfo:
    ...
    restoreSuccess:
      "Paramètres restaurés avec succès. Redémarrage du système...",
  ...
  firmware: {
    ...
    updateAvailable:
      "Une mise à jour vers la version {latestVersion} est disponible.",
    ...
    warning:
      "Attention : Ne débranchez pas l'alimentation pendant la mise à jour !",
  ...
  monitoring: {
    title: "Surveillance",
    description:
      "Configurer la surveillance SNMP et CheckMK pour la passerelle HB-RF-ETH.",
    save: "Enregistrer",
    ...
    snmp: {
      ...
      communityHelp:
        'Par défaut : "public" - Veuillez changer pour la production !',
    ...
    mqtt: {
      ...
      topicPrefixHelp:
        "Par défaut : hb-rf-eth - Les sujets seront comme prefix/status/...",
