export default {
  ...
  settings: {
    ...
    restoreInfo:
      "Upload a backup file to restore settings. The system will restart afterwards.",
  ...
  firmware: {
    ...
    onlineUpdateStarted:
      "Update started. The device will restart automatically once finished.",
  ...
  monitoring: {
    title: "Monitoring",
    description:
      "Configure SNMP and CheckMK monitoring for the HB-RF-ETH gateway.",
    save: "Save",
    saving: "Saving...",
    ...
    mqtt: {
      ...
      topicPrefixHelp:
        "Default: hb-rf-eth - Topics will be like prefix/status/...",
