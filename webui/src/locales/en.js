export default {
  ...
  firmware: {
    ...
    updateAvailable: 'Update available: Version {currentVersion} → {latestVersion}',
    versionCheckFailed: 'Version check failed. Please check your internet connection and try again.',
    onlineUpdate: 'Update Online',
    checkUpdate: 'Check for Updates Now',
    noUpdateAvailable: 'No update available. You are already running the latest version.',
