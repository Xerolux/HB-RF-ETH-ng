export default {
  ...
  settings: {
    ...
    dtlsDescription: 'Secure transport encryption for communication between board and CCU on port 3008.',
    dtlsMode: 'Encryption Mode',
    dtlsModeDisabled: 'Disabled (Default)',
    dtlsModePsk: 'Pre-Shared Key (PSK)',
    dtlsModeCertificate: 'X.509 Certificate',
    dtlsCipherSuite: 'Cipher Suite',
    dtlsCipherAes128: 'AES-128-GCM-SHA256',
    dtlsCipherAes256: 'AES-256-GCM-SHA384 (Recommended)',
    dtlsCipherChacha: 'ChaCha20-Poly1305-SHA256',
    dtlsRequireClientCert: 'Require client certificate',
    dtlsSessionResumption: 'Enable session resumption',
    dtlsPskManagement: 'PSK Management',
    dtlsPskIdentity: 'PSK Identity',
    dtlsPskKey: 'PSK Key (Hex)',
    dtlsPskGenerate: 'Generate new PSK',
    dtlsPskGenerating: 'Generating PSK...',
    dtlsPskGenerated: 'New PSK generated',
    dtlsPskCopyWarning: 'IMPORTANT: Copy this key now! It will only be shown once.',
    dtlsPskKeyLength: 'Key Length',
    dtlsPsk128bit: '128 Bit',
    dtlsPsk256bit: '256 Bit (Recommended)',
    dtlsPsk384bit: '384 Bit',
    dtlsPsk512bit: '512 Bit',
    dtlsPskStatus: 'PSK Status',
    dtlsPskConfigured: 'Configured',
    dtlsPskNotConfigured: 'Not configured',
    dtlsWarningDisabled: 'Communication is UNENCRYPTED. Anyone on the network can intercept traffic.',
    dtlsWarningPsk: 'Ensure the PSK is stored securely on the CCU.',
    dtlsInfo: 'DTLS 1.2 encrypts Raw-UART UDP communication end-to-end. The CCU must also support DTLS.',
    dtlsDocumentation: 'Documentation for CCU Developers',
    dtlsViewDocs: 'View Implementation Guide',
